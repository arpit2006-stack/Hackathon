...
import { FiArrowRight, FiInfo, FiCheckCircle, FiUsers, FiLock, FiAward, FiUser } from 'react-icons/fi';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Secure Voting</h3>
              <p className="text-slate-700">Blockchain-powered technology ensures tamper-proof results and complete transparency.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Voter Verification</h3>
              <p className="text-slate-700">Advanced identity verification prevents fraud while maintaining voter privacy.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Real-time Results</h3>
              <p className="text-slate-700">Instant, auditable results with comprehensive analytics for complete oversight.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-slate-900 mb-12 font-serif">Our Voting Process</h2>
            ...
            <div className="md:w-1/2 space-y-8">
              {[
                ...
                },
                {
                  ...
                  description: "Receive your unique, encrypted ballot for each election you're eligible to vote in.",
                  icon: <FiAward className="text-blue-500" />,
                  color: "blue"
                },
                {
                  title: "3. Cast Your Vote",
                  description: "Submit your choices through our intuitive, accessible voting interface.",
                  icon: <FiCheckCircle className="text-emerald-500" />,
                  color: "emerald"
                },
                {
                  title: "4. Verify & Confirm",
                  description: "Review your selections and confirm your vote is counted in the final tally.",
                ...
                >
                  <div className={`bg-${step.color}-100 p-2 rounded-full mt-1 group-hover:bg-${step.color}-200 transition-all`}>
                    {step.icon}
                  </div>
                  <div>
                    <h3 className={`text-lg font-bold text-slate-900 group-hover:text-${step.color}-600 transition-all`}>{step.title}</h3>
